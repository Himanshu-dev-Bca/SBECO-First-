        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              { icon: <><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></>, label: 'Email', value: '[EMAIL_ADDRESS]', detail: 'We typically respond within 48 hours' },
