...
const VIDEOS = [
  ...
  { id: '2', youtubeId: 'IUdHLF08wJA', title: 'Choosing the Right Industrial Tape', duration: '5:20', category: 'Guide', description: 'Expert guide to selecting the perfect adhesive tape for your packaging needs.' },
