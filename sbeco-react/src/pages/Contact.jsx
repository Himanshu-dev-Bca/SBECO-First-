      ...
      <section className="px-8 md:px-12 py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="flex flex-col gap-5">
            {[
              { icon: <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />, label: 'Phone', value: '+91 88847 46746', detail: 'Mon–Sat, 10:00 AM – 7:30 PM IST' },
              { icon: <><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></>, label: 'Email', value: 'sbeco1985@gmail.com', detail: 'We typically respond within 48 hours' },
